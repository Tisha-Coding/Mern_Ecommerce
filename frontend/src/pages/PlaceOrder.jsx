    ...
    try {
      ...
      for (const items in cartItems) {
        ...
        for (const item in cartItems[items]) {
          console.log(`Item Size: ${item}, Quantity: ${cartItems[items][item]}`); // Debugging item size and quantity
          if (cartItems[items][item] > 0) {
            const itemInfo = structuredClone(products.find(product => product._id === items)); // Use correct _id match here
